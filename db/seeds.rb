...
plant.save!
plant = Plant.new(name: "Dragon Tree", image: "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1557255687-flowers-in-a-pot-indoors-royalty-free-image-940610580-1557255594.jpg?crop=0.649xw:0.974xh;0,0&resize=768:*", description: "Save some room on your windowsill and tuck this low-light variety in an unloved corner. Pet owners, watch out: Dracaena marginata is toxic to both dogs and cats, so keep animals far away.", user: user1, address: 'SE27 9JU')
plant.save!

plant = Plant.new(name: "Snake Plant", image: "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1603654368-51rKhNCtXSL.jpg?crop=1xw:1.00xh;center,top&resize=768:*", description: "One of many sansevierias, snake plant is tough to kill. Those can go for a month without water, say experts. The leaves are typically stiff, sharp, and spikey.", user: user1, address: '32 Wallington Square, Wallington SM6 8RG')
plant.save!
plant = Plant.new(name: "Schefflera", image: "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1603654500-bf16406f-8cbf-40f8-be82-7b212c0945ad.a94deb245dcfae1355350a737e9fa3c4.jpg?crop=0.824xw:0.824xh;0.0913xw,0.0913xh&resize=768:*", description: "This evergreen shrub, also known as an umbrella tree, can grow 15 feet outside, but under the watch of a forgetful gardener it will grow more slowly indoors. Like many plants, it can be mildly toxic.", user: user1, address: 'The Ridge, Purley CR8 3PF')
plant.save!
plant = Plant.new(name: "Dieffenbachia", image: "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1603654572-417RoQcFBmL.jpg?crop=0.842xw:1.00xh;0.0480xw,0&resize=768:*", description: "Place this beauty by a curtained window, protecting new leaves from extra sun. With filtered light, the showy plant is one happy camper.", user: user1, address: 'Warlingham, Whyteleafe CR3 0XB')
plant.save!
plant = Plant.new(name: "Crown of Thorns", image: "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1554479392-1428948147-54ff5f8818e5a-ghk-plants-you-cannot-kill-crown-of-thorns-s2-1554479385.jpg?crop=1.00xw:0.668xh;0,0.183xh&resize=768:*", description: "Yes, this plant can produce prickers, but it's not exactly picky. The succulent shrub can go without water for a week or more and it still produces lovely blooms all year round", user: user1, address: '729 Sidcup Rd, London SE9 3AQ')
plant.save!
