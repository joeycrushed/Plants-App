...
plant.save!
plant = Plant.new(name: "Venus Flytrap", image: "https://images.unsplash.com/photo-1538358519265-586278a34106?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1055&q=80", description: "The Venus flytrap (Dionaea muscipula) is a carnivorous plant native to subtropical wetlands on the East Coast of the United States in North Carolina", user: user, address: 'Coogie, Woodmansterne Ln, Wallington SM6 0SU')
plant.save!
plant = Plant.new(name: "Chinese Money Plant", image: "https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1603654819-il_794xN.2440665192_1z8d.jpg?crop=1xw:1.00xh;center,top&resize=768:*", description: "Pilea peperomioides grows best in a shady spot (or winter windowsill) with weekly watering. You can replant the offshoots that sprout from the base of the stem and give them as gifts.", user: user, address: "Cumberland Wharf, 137 Rotherhithe St, London SE16 5QH")
plant.save!
plant = Plant.new(name: "Yucca", image: "https://images.unsplash.com/photo-1509423350716-97f9360b4e09?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80", description: "The recipe for a happy yucca is easy: sun, sun, and more sun. Plant in a container deep enough to balance the top-heavy woody stems and water sparingly.", user: user, address: '21 Greens End, Thamesmead West, London SE18 6JY')
plant.save!
